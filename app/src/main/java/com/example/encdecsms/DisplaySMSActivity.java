...
public class DisplaySMSActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // user input the DES secret key
                String secretKeyString = secretKey.getText().toString();
                if (secretKeyString.length() > 0 && secretKeyString.length() == 8) {
                    try {
                    ...
                    Toast.makeText(getBaseContext(),
                            "You must provide a 8-character secret key!",
                            Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public static byte[] decryptSMS(String secretKeyString, byte[] encryptedMsg)
        ...
        // get the cipher algorithm for DES
    ...
    private static Key generateKey(String secretKeyString) throws Exception {
        // generate DES secret key from a String
